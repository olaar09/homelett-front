        ...
        <div className="grid max-w-md grid-cols-1 gap-12 mx-auto mt-12 sm:mt-16 lg:max-w-none lg:grid-cols-3 lg:mx-0">
          <div>
            <div className="flex items-center gap-3">
              <svg
                aria-hidden="true"
                className="size-6 shrink-0 text-blue-600 sm:size-8"
            ...
            <ul className="text-base font-normal text-gray-900 mt-8 space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                Give further instructions to the AI
              </li>
              <li className="flex items-start gap-3">
                <div className="shrink-0 py-0.5">
                  <svg
          ...
          <div>
            ...
            <ul className="text-base font-normal text-gray-900 mt-8 space-y-4">
              <li className="flex items-start gap-3">
                ...
                Connect your gmail, indeed, linkedin and jobberman accounts
              </li>
              <li className="flex items-start gap-3">
                <div className="shrink-0 py-0.5">
                  <svg
                ...
                Applications are sent directly from your email like you would.
              </li>
              <li className="flex items-start gap-3">
                <div className="shrink-0 py-0.5">
                  <svg
