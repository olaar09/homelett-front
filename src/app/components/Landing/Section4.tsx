        ...
        <div className="grid grid-cols-1 gap-5 mt-12 sm:grid-cols-2 sm:gap-6 sm:mt-16 md:grid-cols-3 xl:grid-cols-4">
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="inline-flex size-10 items-center justify-center bg-blue-100 text-blue-600 rounded-lg">
                <svg
                  ...
                  viewBox="0 0 256 256"
                >
                  <path d="M216,64H176V56a24,24,0,0,0-24-24H104A24,24,0,0,0,80,56v8H40A16,16,0,0,0,24,80V208a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V80A16,16,0,0,0,216,64Zm-64,88H136v16a8,8,0,0,1-16,0V152H104a8,8,0,0,1,0-16h16V120a8,8,0,0,1,16,0v16h16a8,8,0,0,1,0,16Zm8-88H96V56a8,8,0,0,1,8-8h48a8,8,0,0,1,8,8Z"></path>
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-gray-900 mt-5 sm:text-xl">
                Human level writing
          ...
          <div className="bg-white shadow-xs ring-1 ring-gray-200 rounded-2xl">
            <div className="px-4 py-5 sm:p-6">
              ...
              <p className="text-sm font-normal text-gray-600 mt-2 sm:text-base">
                Get career skills acquisition suggestions based on latest
                industry standards
              </p>
            </div>
          </div>
