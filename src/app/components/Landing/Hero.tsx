      ...
      <div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-xl mx-auto text-center lg:max-w-3xl">
          ...
          <p className="max-w-2xl text-base font-normal text-gray-600 mx-auto mt-3 sm:text-xl sm:mt-5 lg:text-2xl">
            Spend less time searching and more time applying. ApplyBase uses AI
            to match you with high-success potential jobs based on your profile
            and align your CV with each job
          </p>
