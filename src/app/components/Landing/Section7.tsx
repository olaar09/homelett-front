    ...
    <div className="relative">
      ...
      <div className="relative">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative bg-blue-600 rounded-3xl p-8 text-center sm:p-16 md:px-24 md:py-20 lg:px-28">
            ...
            <div className="relative">
              <div className="max-w-2xl mx-auto">
                ...
                <p className="max-w-lg text-base text-blue-100 mx-auto mt-5 sm:text-lg">
                  Automatically apply to 50+ jobs daily from all over the world,
                  with your CV modified to each job requirement
                </p>
              </div>
